...
public class Listeners implements ITestListener, IRetryAnalyzer, IAnnotationTransformer {
   ...
   //            "-> FAILED olan testlerden sonra tek bir sefer çağrılır " + result.getName());
   ...
   //}
    ...
    public boolean retry(ITestResult result) {
        ...
        /*
        Bu method sadece FAIL olan test case'leri tekrar çalıştırır.maxRetryCount ek olarak çalisma sayısıdır.Bu
        örnekte Fail olan test (maxRetryCount=1) normal bir kere çalıştıktan sonra fail olursa 1 kez daha  çalışacaktır.
        */
    ...
    public void transform(ITestAnnotation annotation, Class testClass, Constructor testConstructor, Method testMethod) {
        ...
        olanak sağlar.Bu method sayesinde @Test annotation a sahip methodları yapılandırıp testin başarısız olma
        durumunda otomatik olarak testleri retry methodunda belirttiğimiz sayı miktarınca tekrar çalıştıracaktır.
        */
