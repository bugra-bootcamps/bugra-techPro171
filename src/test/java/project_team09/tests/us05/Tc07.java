...
public class Tc07  {
    /*
    bu tc' m de doldurulması zorunlu olmayan bir alanın doldurulunca editleme islemi yapılıp yapılmadığını test etmeye calıştım
    fakat iframe e geçis yapamadım bir türlü
     */
    @Test
    public void test01() {
...
//"Biography" bölümüne birseyler yaz
...
//
        ...
        String biography=ConfigReader.getProperty("biography");
        page.ifarmeBiography.sendKeys(biography);
        //extentTest.info("BIOGRAPHY BÖLÜMÜNE BİRSEYLER YAZILDI");
